...
const Home = () => {
  ...
  return (
    <div className="min-h-[100vh] w-full bg-gradient-to-b from-blue-50 to-white flex flex-col items-center p-2 sm:p-4">
      <h1 className="text-2xl sm:text-4xl font-bold text-blue-800 mb-4 sm:mb-6">StudyMitra</h1>
